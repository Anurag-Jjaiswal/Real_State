  ...
  return (
    <div className="bg-white">
      <div className="flex  justify-between  px-4 items-center max-w-[98vw] sm:max-w-[90vw]  lg:max-w-[85vw]  mx-auto whitespace-nowrap">
        <div className="lg:hidden flex items-centers">
          {/* first logo */}
        ...
        <div className="hidden lg:flex">
          <ul className=" flex space-x-1 py-4">
            {buttons.map((button) => (
              <NavBtn
                title={button.title}
        ...
        {/* last logo */}
        <div className="w-10 h-10 bg-[#d72c2c] rounded-full text-white flex items-center justify-center lg:hidden  ">
          <HiOutlineUser className="text-[28px]" />
        </div>
        <div className=" hidden lg:flex items-center pl-6 text-[15px]">
          <button>Log in</button>
          <div className=" bg-[#d72c2c] py-[6px] text-white rounded-full px-4 ml-6 flex items-center">
